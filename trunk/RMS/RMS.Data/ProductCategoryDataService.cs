...
namespace RMS.Data
{
    public class ProductCategoryDataService : BaseDataService, IProductCategoryDataService
    {
        ...
        public ServiceResult<int> SaveProductCategory(ProductCategory productCategory)
        {
            ...
            parameters.AddParam("I_vProductCategoryID", productCategory.ProductCategoryID, SqlDbType.SmallInt);
            ...
            parameters.AddParam("O_vProductCategoryID", "", SqlDbType.SmallInt, ParameterDirection.Output);
        ...
        {
            var parameters = new SprocParameters();
            parameters.AddParam("I_vProductCategoryID", productCategoryID, SqlDbType.SmallInt);
