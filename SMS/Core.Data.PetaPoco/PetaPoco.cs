...
using Core.Data.PetaPoco.DatabaseTypes;
using Core.Data.PetaPoco.Internal;
using System;
...
namespace Core.Data.PetaPoco
{
	...
	public class Database : IDisposable
	{
        ...
        /// Construct a database using a supplied connections string and optionally a provider name
        /// </summary>
        /// <param name="config">The DB config</param>
        /// <remarks>
        /// PetaPoco will automatically close and dispose any connections it creates.
        /// </remarks>
        public Database(IConfig config) :this(config.ConnectionString, config.DbProvider)
        {}
	...
	namespace Internal
	{
		...
		class PocoData
		{
			...
			private static Func<object, object> GetConverter(IMapper mapper, PocoColumn pc, Type srcType, Type dstType)
			{
                ...
                else if (srcType == typeof(int) && (dstType == typeof(long) || dstType == typeof(long?)))
                {
                    return delegate(object src) { return src == null ? (long?) null : long.Parse(src.ToString()); };
                }
