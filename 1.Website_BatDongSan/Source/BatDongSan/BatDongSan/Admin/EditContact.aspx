<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditContact.aspx.cs" Inherits="BatDongSan.Admin.EditContact" Title="Chỉnh sửa nội dung trang Liên hệ" %>
...
<div id="content">
        <div class="top">
            ...
            <p class="section_title">
                Thay đổi nội dung trang liên hệ</p>
        </div>
        <div class="mid">
