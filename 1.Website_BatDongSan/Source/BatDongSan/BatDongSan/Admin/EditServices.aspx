<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="EditServices.aspx.cs" Inherits="BatDongSan.Admin.EditServices" Title="Chỉnh sửa nội dung trang Dịch vụ" %>
    ...
    <div id="content">
        <div class="top">
            ...
            <p class="section_title">
                Thay đổi nội dung trang Dịch vụ</p>
        </div>
        <div class="mid">
            <asp:DetailsView ID="DetailsView1" CssClass="tbl" runat="server" AutoGenerateRows="False"
                DataKeyNames="ID" DataSourceID="LinqDataSource3" DefaultMode="Edit" Width="695px"
                GridLines="None">
                <Fields>
